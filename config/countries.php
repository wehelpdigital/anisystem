...
/**
 * Every country a farmer can say they are in — ISO 3166-1 alpha-2 code to
 * name. The flag is drawn from the code (App\Support\Region::flag), so
 * nothing here needs an emoji. The Philippines is the home market and is
 * listed first by the picker; the rest read in English alphabetical order.
 */
return [
    'PH' => 'Philippines',
