...
Route::middleware(['auth', 'subscription'])->group(function () {
    ...
    Route::post('/app/sm-media-posters-backfill', [App\Http\Controllers\Manager\MediaPickerController::class, 'backfillPosters'])->name('sm.media-picker.poster-backfill');
