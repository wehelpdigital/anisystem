...
class AccountController extends Controller
{
    ...
    {
        // The credits log lives on My Credits now; an old link still lands.
        if ($request->query('tab') === 'credits') {
            return redirect()->route('ai.credits', array_filter(['page' => $request->query('credits')]));
        }
