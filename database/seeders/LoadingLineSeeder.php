...
class LoadingLineSeeder extends Seeder
{
    ...
    private const LINES = [
        ...
        // ---- Animals ----------------------------------------------------
        ['Shade the seedbed in the hottest hours.', 'A tray that dries out at noon is a week lost.', 'shade'],
        ['Rest before you are tired, not after.', 'After is when the mistakes start.', 'nap'],
        ['Check the hooves after wet weeks.', 'Standing in mud softens them.', 'rain'],
        ['Nothing transplants well at noon.', 'Wait for the afternoon; the seedling will thank you.', 'transplant'],
        // ---- The good insects -------------------------------------------
        ...
        ['Never leave a child in a parked vehicle.', 'It is hotter in there than in the field.', 'thermometer'],
        ...
        ['Scout on a schedule, not on a hunch.', 'Write the date where you will see it.', 'label'],
        ['Keep the drinking water out of the sun.', 'Warm water in a drum is water nobody touches.', 'bucket'],
        ...
        // ---- Forty more, all of them about a crop -----------------------
        ['Buy seed from somebody who can name the lot.', 'Cheap seed of unknown parentage is the dearest thing in the field.', 'sprout'],
        ['Test a handful of last season\'s seed first.', 'Ten in a wet cloth. Under seven up, buy new.', 'nursery'],
        ['Sow the seedbed thinner than feels right.', 'Crowded seedlings make weak transplants every time.', 'nursery'],
        ['Harden the seedlings before they go out.', 'Three days of real sun, or the field burns them in one.', 'transplant'],
        ['Lift seedlings with soil on the roots.', 'A bare root is a week of standing still.', 'transplant'],
        ['Level the field before you flood it.', 'Every dip is a drowned hill and every hump is a weed patch.', 'soil'],
        ['Walk the bunds before the first irrigation.', 'One rat hole empties a paddy overnight.', 'canal'],
        ['Do not work soil that smears.', 'Wait two days. Smeared soil sets like a road.', 'soil'],
        ['Rotate the family, not just the crop.', 'Tomato after eggplant is the same disease twice.', 'weeds'],
        ['Leave the stubble if you can.', 'It feeds the soil and holds it through the first storm.', 'compost'],
        ['Water in the morning, not the evening.', 'A leaf that goes to bed wet wakes up with disease.', 'watering'],
        ['Water the soil, not the leaves.', 'Most of what you spray on a leaf evaporates.', 'hose'],
        ['Check the field the day after rain.', 'Standing water for three days kills roots you cannot see.', 'flood'],
        ['Drain before harvest, not on the day.', 'A week of drying carries the crew and the sacks.', 'canal'],
        ['Mulch is cheaper than irrigation.', 'Straw on the bed holds more water than another pass with the hose.', 'compost'],
        ['Split the nitrogen, do not dump it.', 'Three small doses beat one big one every season.', 'granule'],
        ['Feed after weeding, never before.', 'Otherwise you are fertilising the weeds.', 'weeds'],
        ['Do not put fertiliser against the stem.', 'Two fingers away. On the stem it burns.', 'fertbag'],
        ['A soil test is cheaper than a season of guessing.', 'Once every three years is enough.', 'soil'],
        ['Compost is slow and it is not optional.', 'Fertiliser feeds this crop; compost feeds the next ten.', 'compost'],
        ['Look under the leaf, not on top of it.', 'Almost everything that eats a crop lives underneath.', 'pest'],
        ['Pull the first sick plant out entirely.', 'One plant now, or a row of them in a fortnight.', 'weeds'],
        ['Do not spray on a schedule.', 'Spray when you have seen the thing you are spraying for.', 'spray'],
        ['Change the chemical group, not just the brand.', 'Two brands of the same thing is one thing, twice.', 'spray'],
        ['Weeds are hardest in the first month.', 'The crop cannot compete yet and will not tell you it is losing.', 'weeds'],
        ['Net the fruit before it colours.', 'Once the birds have found it they come back with friends.', 'net'],
        ['Trap the snails at dusk.', 'That is when they move, and they are easy to see.', 'snail'],
        ['Prune for light, not for tidiness.', 'A branch that shades another one is the branch to take.', 'bolo'],
        ['Whitewash a young trunk before the dry months.', 'Sunscald splits bark that never grows back the same.', 'shade'],
        ['Thin the fruit when it sets.', 'A hundred good ones beat three hundred small ones.', 'basket'],
        ['Mulch to the drip line, not to the trunk.', 'Mulch touching bark is how collar rot starts.', 'compost'],
        ['A tree checked in its first two years is behind for twenty.', 'Water it through the dry season even when it looks fine.', 'watering'],
        ['Stake before the plant needs it.', 'Staking a fallen plant breaks the roots you were saving.', 'ladder'],
        ['Pick the vegetables young and pick often.', 'A plant allowed to ripen one fruit stops making the next ten.', 'basket'],
        ['Take the lowest leaves off a fruiting bush.', 'Nothing that touches soil should still be on the plant.', 'bolo'],
        ['Even water, or the fruit splits.', 'Dry then flooded is what cracks a tomato.', 'hose'],
        ['Harvest in the cool of the morning.', 'An hour in the sun on a tricycle is a grade off the price.', 'basket'],
        ['Dry to fourteen per cent, not to \'looks dry\'.', 'A moisture meter pays for itself in one wet season.', 'dry'],
        ['Cool the vegetables before they travel.', 'Field heat in a closed sack is a day off the shelf life.', 'store'],
        ['Handle it once.', 'Every extra handling is a bruise you sell at a discount.', 'basket'],
        ['Know the price before you cut.', 'A buyer who quotes after the harvest quotes lower.', 'money'],
    ];
}
