 ...
 * anee.io footer and managed from the mother app. Shared `as_*` conventions:
    ...
    public function up(): void
    {
        ...
        $defaults = [
            ['slug' => 'privacy', 'title' => 'Privacy Policy', 'order' => 1, 'body' =>
                '<p>Your privacy matters to us. This policy explains what information anee.io collects, how we use it, and the choices you have.</p>'
                ...
                . '<h3>How we use it</h3><p>To run the service, personalise your dashboard and community, and improve anee.io. Community posts you choose to share are visible to other members.</p>'
            ...
            ['slug' => 'terms', 'title' => 'Terms of Service', 'order' => 2, 'body' =>
                '<p>By using anee.io you agree to these terms. Please read them carefully.</p>'
                . '<h3>Using the service</h3><p>Use anee.io lawfully and respectfully. You are responsible for the accuracy of the data you enter and for keeping your account secure.</p>'
            ...
            ['slug' => 'cookies', 'title' => 'Cookie Policy', 'order' => 3, 'body' =>
                '<p>anee.io uses cookies to keep you signed in and to remember your preferences.</p>'
            ...
            ['slug' => 'about', 'title' => 'About anee.io', 'order' => 4, 'body' =>
                '<p>anee.io helps Filipino farmers plan and run a productive cropping season — from lots, workers and activities to reports and a supportive community.</p>'
                ...
                . '<h3>The community</h3><p>Beyond the tools, anee.io is a place for co-farmers to swap tips, ask questions, and learn from the anee.io team.</p>'],
        ];
