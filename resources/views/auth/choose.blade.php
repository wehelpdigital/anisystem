...
<div class="ch-wrap">
    <div class="ch-card app-fade-in">
        ...
        <div class="ch-list">
            @foreach ($hats as $hat)
                @if ($hat['kind'] === 'admin')
                    <a class="ch-opt ch-admin" href="{{ $hat['url'] }}" target="_blank" rel="noopener">
                        <span class="ch-ico">
                        ...
                        <svg class="ch-go w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7-7 7M3 12h18"/></svg>
                    </a>
                @else
