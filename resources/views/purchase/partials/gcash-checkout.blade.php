{{--
    Manual-GCash checkout: receiving details, steps, and the proof-of-payment
    form. Shared by the subscription and AI-credit flows.

    Expects:
      $gcash        payment settings row (may be null)
      $price        float
      $summaryLabel string  e.g. "Farmer" or "Starter"
      $summaryMeta  string  e.g. "30 days" or "350 credits"
