...
<head>
    ...
    {{-- Offline Mode is a paid convenience, judged by the farm being worked:
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div x-show="open" x-cloak x-transition
                            ...
                            <button type="button" id="offlineModeToggle"
                                ...
                                @if ($offlineLocked)
                                    <span class="tl-lock"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:1rem;height:1rem"><rect x="4" y="10.5" width="16" height="10" rx="2.5"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg></span>
                                @else
                        ...
                        <div class="sheet hidden" id="farmSwitchSheet" style="--sheet-width:24rem">
                            ...
                            <div class="sheet-body dt-rows" style="padding-bottom:1.1rem">
                                {{-- Your own land first, ALWAYS: every worker
                                     ...
                                     farm" is dealt here exactly as the login
                                     chooser deals it — even before a first
                                     schedule exists, because starting one is
                                     what the door is for. Posting 0 clears
    ...
    <footer class="mt-6 md:mt-10 border-t border-gray-100 footer-safe">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 pb-6 -mt-2">
            <p class="text-xs text-gray-400 text-center sm:text-right flex items-center justify-center sm:justify-end gap-1.5">
                Made with
                <svg class="w-3.5 h-3.5 text-brand-600 footer-heart" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21s-7.5-4.9-9.6-9A5.6 5.6 0 0 1 12 6.3a5.6 5.6 0 0 1 9.6 5.7C19.5 16.1 12 21 12 21z"/></svg>
