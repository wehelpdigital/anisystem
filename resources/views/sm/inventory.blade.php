...
<style>
    ...
    .ivp-face { width: 2.4rem; height: 2.4rem; border-radius: .75rem; display: inline-flex; align-items: center;
        justify-content: center; font-size: 1.25rem; background: var(--color-brand-50); flex: none; }
