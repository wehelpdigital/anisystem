...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
        ...
        <button type="button" id="quickCaptureBtn"
            class="quick-capture-cta card-hover flex flex-col items-start justify-center gap-2 rounded-2xl p-5 text-left text-white transition hover:brightness-105 active:scale-[.99]"
            style="background-color: #e0a458;">
            <span class="w-12 h-12 rounded-xl bg-white/25 flex items-center justify-center shrink-0">
            ...
            <span class="text-sm text-white/90 leading-snug">Snap a photo → notes or AI</span>
        </button>
    </div>
