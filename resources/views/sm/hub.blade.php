...
@php
    ...
    $doorOpen = [
        ...
        'draw' => $may('draw'),
        'ai' => $may('ai'),
        // Tags ride the board's forms, so the door follows the board.
        'tags' => $may('activities'),
    ];
    // Modules whose icon is a drawn picture rather than a stroked glyph.
    // One line here (plus the file in public/images) swaps a tile's face.
    $modulePics = [
        'settings' => 'gear.png',
    ...
    $moduleCards = [
        ...
        // A luggage tag: the words a farmer ties to the season's things.
        ['Tags', 'tags', null,
            'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A2 2 0 013 11V5a2 2 0 012-2h2z'],
