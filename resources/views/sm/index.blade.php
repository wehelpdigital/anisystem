...
@section('content')
    ...
    @endphp
    {{-- The "Working at ..." line moved into the top bar (see layouts/app),
         where it is true on every screen instead of only this one. The old
         card and its own switcher sheet went with it — one answer, one
         door. --}}
