...
<style>
    ...
    /* Folded to its headline by default: an empty chat should fit its
       ...
       worked pair. */
    .aif-howto-fold { display: none; }
    .aif-howto.is-open .aif-howto-fold { display: block; }
    .aif-howto-h { cursor: pointer; width: 100%; }
    .aif-howto-chev { margin-left: auto; width: .9rem; height: .9rem; flex: none;
        transition: transform .28s cubic-bezier(.22,1,.36,1); }
    .aif-howto.is-open .aif-howto-chev { transform: rotate(180deg); }
    .aif-howto-rule { display: block; height: 1px; margin: .45rem 0;
        background: var(--color-gray-200); border: 0; }
    html.dark .aif-howto-rule { background: #2b3a1c; }
    @media (prefers-reduced-motion: reduce) { .aif-howto-chev { transition: none; } }
