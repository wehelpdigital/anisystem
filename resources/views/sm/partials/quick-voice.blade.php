...
(function quickVoice() {
    ...
    $('qvSave').addEventListener('click', async () => {
         ...
         * false - which answers TRUE for a phone attached to a router with
         * nothing behind it, so the voice note was lost with a red toast.
         * The upload is simply tried; a fetch that throws reached nobody,
