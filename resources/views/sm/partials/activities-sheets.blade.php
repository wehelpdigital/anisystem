...
<div class="sheet hidden" id="cardMenuSheet" style="--sheet-width:24rem">
    ...
    <div class="sheet-body">
        <div class="grid gap-1">
            ...
            <button type="button" class="btn btn-ghost justify-start!" data-card-menu-action="share">Share…</button>
...
{{-- ============================ SHARE ACTIVITY (public link) ============================ --}}
<div class="sheet hidden" id="activityShareSheet" style="--sheet-width:26rem">
    <div class="sheet-handle"></div>
    <div class="sheet-header">
        <h3 class="sheet-title truncate" id="activityShareTitle">Share activity</h3>
        <button data-sheet-close class="btn-ghost p-2 rounded-full" aria-label="Close">✕</button>
    </div>
    <div class="sheet-body space-y-3">
        <p class="text-sm text-gray-600">Anyone with this link can view this activity — no login needed. Great for Facebook, Messenger, or email.</p>
        <div class="flex gap-2">
            <input type="text" id="activityShareLink" class="form-input grow" readonly onclick="this.select()">
            <button type="button" id="activityShareCopy" class="btn btn-secondary shrink-0">Copy</button>
        </div>
        <div class="grid grid-cols-2 gap-2">
            <a id="activityShareFb" href="#" target="_blank" rel="noopener" class="btn btn-ghost justify-start!">
            ...
            <a id="activityShareWa" href="#" target="_blank" rel="noopener" class="btn btn-ghost justify-start!">
            ...
            <a id="activityShareEmail" href="#" class="btn btn-ghost justify-start!">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Email
            </a>
            <button type="button" id="activityShareNative" class="btn btn-ghost justify-start!" style="display:none">
